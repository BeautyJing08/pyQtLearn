...
class Ui_SignUpForm(object):
    def setupUi(self, SignUpForm):
        ...
        self.label_date_change.setGeometry(QtCore.QRect(240, 60, 131, 16))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.label_AlreadyBookNumChange.setGeometry(QtCore.QRect(240, 180, 21, 16))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.widget = QtWidgets.QWidget(SignUpForm)
        self.widget.setGeometry(QtCore.QRect(280, 180, 95, 18))
        self.widget.setObjectName("widget")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label_alreadyBookNum_2 = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.label_alreadyBookNum_2.setFont(font)
        self.label_alreadyBookNum_2.setObjectName("label_alreadyBookNum_2")
        self.horizontalLayout.addWidget(self.label_alreadyBookNum_2)
        self.label_alreadyBookNum_man_change = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.label_alreadyBookNum_man_change.setFont(font)
        self.label_alreadyBookNum_man_change.setVisible(False)
        self.label_alreadyBookNum_man_change.setObjectName("label_alreadyBookNum_man_change")
        self.horizontalLayout.addWidget(self.label_alreadyBookNum_man_change)
        self.label_alreadyBookNum_man = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.label_alreadyBookNum_man.setFont(font)
        self.label_alreadyBookNum_man.setObjectName("label_alreadyBookNum_man")
        self.horizontalLayout.addWidget(self.label_alreadyBookNum_man)
        self.label_alreadyBookNum_women_change = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.label_alreadyBookNum_women_change.setFont(font)
        self.label_alreadyBookNum_women_change.setVisible(False)
        self.label_alreadyBookNum_women_change.setObjectName("label_alreadyBookNum_women_change")
        self.horizontalLayout.addWidget(self.label_alreadyBookNum_women_change)
        self.label_alreadyBookNum_women = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.label_alreadyBookNum_women.setFont(font)
        self.label_alreadyBookNum_women.setObjectName("label_alreadyBookNum_women")
        self.horizontalLayout.addWidget(self.label_alreadyBookNum_women)
        self.label_alreadyBookNum_5 = QtWidgets.QLabel(self.widget)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        self.label_alreadyBookNum_5.setFont(font)
        self.label_alreadyBookNum_5.setObjectName("label_alreadyBookNum_5")
        self.horizontalLayout.addWidget(self.label_alreadyBookNum_5)
    ...
    def retranslateUi(self, SignUpForm):
        ...
        self.label_alreadyBookNum_2.setText(_translate("SignUpForm", "( "))
        self.label_alreadyBookNum_man_change.setText(_translate("SignUpForm", "20"))
        self.label_alreadyBookNum_man.setText(_translate("SignUpForm", "男"))
        self.label_alreadyBookNum_women_change.setText(_translate("SignUpForm", "20"))
        self.label_alreadyBookNum_women.setText(_translate("SignUpForm", "女"))
        self.label_alreadyBookNum_5.setText(_translate("SignUpForm", ")"))
